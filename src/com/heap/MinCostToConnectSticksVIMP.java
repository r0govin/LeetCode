...
public class MinCostToConnectSticksVIMP {

	public static void main(String[] args) {
		MinCostToConnectSticksVIMP minCost = new MinCostToConnectSticksVIMP();
		int[] sticks = { 1, 8, 3, 5 };
		int connectSticks = minCost.connectSticks(sticks);
